    ...
    <footer className="bg-[#1a1f2e] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-16">
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            <li><Link href="#" className="hover:text-white transition-colors">Real Estate Lead Generation</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Residential Properties</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Flats for Rent Near Me</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Jewar Airport Plots</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            <li><Link href="#" className="hover:text-white transition-colors">Flats in New Ashok Nagar</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">1 BHK Flat Rent</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Flats for Sale Delhi</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">1 BHK Flat Sale</Link></li>
          </ul>
        </div>
