    ...
    <>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button
          ...
          className="relative bg-blue-600 text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group"
        >
          {!isOpen && (
            <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-8 z-50 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-slide-up">
          {/* Chat Header */}
